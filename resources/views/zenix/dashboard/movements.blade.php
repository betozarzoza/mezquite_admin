								...
								<tbody>
									@foreach ($movements as $movement)
										...
										<td>@if ($movement->type == 'ingreso')
											...
											@endif </td>
										<td>
											<a href="https://condominioselmezquite.homes/invoice_mezquite/{{$movement->id}}">Ver recibo</a>
											<br>
											@if ($user->is_admin == 1)
												<a href="https://condominioselmezquite.homes/invoice_mezquite/{{$movement->id}}">Enviar correo</a>
											@endif
										</td>
									</tr>
									@endforeach
